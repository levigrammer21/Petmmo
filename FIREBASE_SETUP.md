...
6. Start a one-hour pet activity, refresh, and confirm its session countdown remains.
7. Start a combat patrol with one pet, assign another pet to a timed Processing shift, close the tab briefly, then return and confirm both timers progressed.
