...
## 3. Upload version 0.7.0 to GitHub
...
If you already completed the rules/index deployment successfully for version 0.3.0 or later, **skip this step**. Version 0.7.0 changes the game screen, save schema, and browser-side engine; its Firestore rules and indexes are unchanged.
...
2. Refresh once so Chrome receives version 0.7.0.
